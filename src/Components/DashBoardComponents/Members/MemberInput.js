    ...
    <div className="m-5">
      <form onSubmit={handleSubmit}>
        <div className="flex justify-between">
          ...
          <button
            type="submit"
            style={{ backgroundColor: "#522949" }}
            className="ml-2 px-4 py-2 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            Send Invite
          </button>
        </div>
